...
/**
  ...
  */
add_action('delete_attachment', 'tm_mr_delete_resized_images');
function tm_mr_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {
  global $wpdb;
  // Get common vars
  $args = func_get_args();
  $common = tm_mr_common_info($args);
...
function tm_mr_common_info($args) {
  // Unpack arguments
...
function tm_mr_delete_resized_images($post_id) {
