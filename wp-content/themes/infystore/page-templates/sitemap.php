    ...
    <div id="content" class="site-content sitemap" role="main">
      ...
      <div class="archive-content">
			...
			<div class="sitemap-item">
			  <div class="sitemap-pages">
				<h2>
				  <?php esc_html_e('Pages','infystore');?>
				</h2>
				<ul>
       ...
       <div class="sitemap-item">
			  <div class="sitemap-category">
				<h2>
				  <?php esc_html_e( 'Category Archives','infystore'); ?>
				</h2>
				<ul>
				  <?php wp_list_categories( array( 'feed' => esc_html__( 'RSS', 'infystore' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
				</ul>
			  </div>
			  <div class="clear"></div>
			  <div class="sitemap-month-archieves">
				<h2>
				  <?php esc_html_e( 'Monthly Archives','infystore'); ?>
				</h2>
				<ul>
			  ...
			  <div class="sitemap-authors">
				<h2>
				  <?php esc_html_e( 'Author Archives','infystore'); ?>
				</h2>
				<ul>
      ...
      <div class="sitemap-item">
          <div class="sitemap-posts">
            <h2>
              <?php esc_html_e( 'Blog Posts','infystore'); ?>
            </h2>
            <ul>
              <?php 
				$archivesquery = new WP_Query('showposts=20');
				while ($archivesquery->have_posts()) : $archivesquery->the_post(); ?>
              <li> <a href="<?php esc_url(the_permalink()) ?>"  rel="bookmark" title="<?php printf( esc_html__("Permanent Link to %s", 'infystore'), get_the_title() ); ?>">
                <?php the_title(); ?>
                </a> (
